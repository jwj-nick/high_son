...
> 최종 갱신: 2026-08-19 (17차 게이트·중간고사 대비 착수) · 작업트리 클린 · 원격 동기
...
**지금의 초점 = 2학기 중간고사(9/8~11) 대비.** 한국사(아이가 많이 약함, 범위=일제강점기)에 **기본기 세트 `kh2_04`(중·중상)** + 시기 훈련 탭 + 기본기/심화 전환을 만들어 배포했다(17차 게이트). 신규 과목 **공통국어2**(미래엔 신유식, 문학 중심)를 착수해 옛노래 앱(제망매가·속미인곡+중세국어 연계)을 배포했다. **다음 = ① 아이의 kh2_04 첫 풀이 결과 회수 → 재시험 루프 가동 ② 국어 춘향전 앱 ③ 수학은 경영·경제 인사이트 박스 완료 상태.**
...
| **공통국어2** | 1단원 옛노래(+3단원 연계) | 앱 | ✅ 국어 게이트 | ✅ 라이브 `korean/kor2_hub.html` |
...
| **1'** | **중간고사 대비(9/8~11)** — 아이 kh2_04 첫 풀이 결과 회수 → 재시험 루프 · 국어 춘향전 앱 · 시기훈련 반응 확인 | **아이 풀이** | 중 |
