...
| **2'** | **고2 수학 3과목(대수·미적분Ⅰ·확통) 흥미 갈래 앱** — P0 정본 완료(2026-09-02). 다음 = P1 대수(관문 특강 G6~G8 → 9단원 앱 → 허브·인덱스·배포). SSOT `subject_hub/수능수학_PLAN.md` + 과목별 PLAN.md. 세션 위치 = `subject_hub` | — | 대(Phase 3개) |
