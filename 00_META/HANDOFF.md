...
> 최종 갱신: 2026-08-21 (**FLOW V2 — 아웃루프 차단, 앱 자기완결 루프**) · ⭐신규 SSOT: [`FLOW_V2_INAPP_LOOP.md`](FLOW_V2_INAPP_LOOP.md)
...
**다음 차례(우선순위순):** ① **FLOW V2 확장** — ~~한국사2 나머지 단원~~(✅ 08-21 완료: 개항기·현대 훈련 탭 라이브) → **한국사1 전 단원**(앱 4개는 있으나 세트·실전 탭 없음 — RUNBOOK 세트 출제부터, 고대→고려→조선→조선후기) ② 사회2·과학2 DRILL_FIX 맵과 "고치는 곳" 보강 ③ Nick 교과서 사진(속미인곡 표기·춘향전 대목·2단원 용어) 오면 국어 보정 ④ 국어 3단원 별도 앱 ⑤ 시험 직전 "전 단원 섞어 풀기" 모드. **아이 결과 회수 대기는 폐기됐다(2026-08-21)** — 루프는 앱 안에서 돈다.
