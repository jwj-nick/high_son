...
**다음 차례(우선순위순):** ① **FLOW V2 확장** — 한국사2 나머지 단원 앱에 훈련 탭(원칙 B)+DRILL_FIX 이식 → 한국사1 전 단원(아이가 한국사 전체 약함) ② 사회2·과학2 DRILL_FIX 맵과 "고치는 곳" 보강 ③ Nick 교과서 사진(속미인곡 표기·춘향전 대목·2단원 용어) 오면 국어 보정 ④ 국어 3단원 별도 앱 ⑤ 시험 직전 "전 단원 섞어 풀기" 모드. **아이 결과 회수 대기는 폐기됐다(2026-08-21)** — 루프는 앱 안에서 돈다.
...
| 과목 | 단원 | 문항 | 게이트 | 배포 |
|---|---|---|---|---|
| **한국사2** | Ⅰ·Ⅱ·Ⅲ (3/3) + **Ⅱ기본기 kh2_04** | 48 | ✅ | ✅ 라이브 (기본기/심화 전환 + **혼동쌍 탭**: 카드13·판별31 + 결과 갈래 안내) |
...
| **1'** | **FLOW V2 확장** — ⓐ 한국사2 나머지 단원 앱 훈련 탭+DRILL_FIX ⓑ 한국사1 전 단원 ⓒ 사회2·과학2 DRILL_FIX 보강 ⓓ 시험 직전 전단원 섞어 풀기 모드 | — | 대 |
