...
| 12 | 왼쪽 사이드바 · 수학 전체 허브 · 학기 디렉토리 | `high1/math/` 전체 · 앱 37 | 📋 **백로그**(Nick 지시 2026-09-06). 중등에 있는 왼쪽 사이드바가 고등에는 없고, `high1/math/`가 학기 구분 없이 평면이다. 목표·단계·위험 = [`수학허브_개편_BACKLOG.md`](수학허브_개편_BACKLOG.md). P1 사이드바·P2 허브는 지금도 착수 가능, **P3 디렉토리 이동은 점검 세트 배치 1·2가 끝난 뒤**(파일 이동과 세트 이식이 충돌). |
