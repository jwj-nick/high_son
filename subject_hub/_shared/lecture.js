...
(function () {
  ...
  var CSS = ''
    ...
    + '.lec-goal{display:flex;flex-wrap:wrap;gap:8px;margin-top:14px}.lec-goal a{background:rgba(255,255,255,.22);border-radius:999px;padding:6px 13px;font-size:12.5px;font-weight:700;color:#fff;text-decoration:none;min-height:34px;display:inline-flex;align-items:center}'
    ...
    + '.lec-nav a{flex:0 0 auto;font-size:12px;font-weight:700;color:var(--sub);background:var(--panel);border:1px solid var(--line);border-radius:999px;padding:7px 12px;text-decoration:none;min-height:34px;display:inline-flex;align-items:center;gap:5px}'
    ...
    + '.lec-widget canvas{display:block;width:100%;border-radius:10px;background:#fff;touch-action:none}'
    ...
    + '.lec-again{background:none;border:1.5px solid var(--lec);color:var(--lec);border-radius:999px;padding:8px 14px;font-size:12.5px;font-weight:700;cursor:pointer;min-height:40px}'
    ...
    + '#printCheat{background:#fff;color:var(--lec);border:none;border-radius:999px;padding:9px 18px;font-weight:800;font-size:13px;cursor:pointer;margin-top:12px;min-height:40px}'
